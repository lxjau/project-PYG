  ...
  <div class="trade-container">
    ...
    <div class="trade">
      ...
      <div class="receiveInfo">
        寄送至:
        <span>{{userGoodsAddress.fullAddress}}</span>
        收货人：<span>{{userGoodsAddress.consignee}}</span>
        <span>{{userGoodsAddress.phoneNum}}</span>
      </div>
    </div>
...
<script>
  export default {
    ...
    computed:{
      ...
      orderInfo(){
        return this.$store.state.trade.orderInfo
      },
    ...
    methods: {
     ...
     async submitOrder(){
       ...
       let data = {
         consignee:this.userGoodsAddress.consignee,
         consigneeTel:this.userGoodsAddress.phoneNum,
         deliveryAddress:this.userGoodsAddress.fullAddress,
         paymentWay:'ONLINE',
