...
export default {
  ...
  computed: {
    attrsList() {
      return this.$store.state.search.searchList.attrsList;
    },
    trademarkList() {
      return this.$store.state.search.searchList.trademarkList;
    },
  },
  methods: {
    // 品牌
    getTrademark(trademark) {
      this.$emit("getTrademarkData", trademark);
    },
    // 属性
    attr(attrs, attrValue) {
